...
- Consider keeping the code separate, imported by the notebook. At a minimum, a single file `custom_functions.py` which is imported once and contains all the necessary functions. 
